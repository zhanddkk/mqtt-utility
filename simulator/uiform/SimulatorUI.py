...
class Ui_SimulatorUI(object):
    def setupUi(self, SimulatorUI):
        ...
        self.plainTextEditLog = QtWidgets.QPlainTextEdit(self.dockWidgetContents_3)
        self.plainTextEditLog.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.plainTextEditLog.setObjectName("plainTextEditLog")
        self.gridLayout_3.addWidget(self.plainTextEditLog, 0, 0, 1, 1)
    ...
    def retranslateUi(self, SimulatorUI):
        ...
        self.treeWidgetPackageInfo.topLevelItem(8).setText(0, _translate("SimulatorUI", "Object Reference type"))
        self.treeWidgetPackageInfo.topLevelItem(9).setText(0, _translate("SimulatorUI", "Object Reference value"))
